...
export const sectors: ContentPage[] = [
  {
    ...
    faqs: [
      {
        question:
          "What quantum experts are needed for construction disputes?",
        answer:
          "Construction disputes typically need two types of expert: a delay analyst (programme expert) to establish entitlement to extensions of time, and a quantum expert (usually a chartered quantity surveyor or forensic accountant) to value the financial loss and expense flowing from the delay and disruption. The quantum expert translates the factual and programme position into monetary heads, prolongation, disruption, variations, and loss and expense, and prepares the schedules and expert report required for adjudication, arbitration, or court.",
      },
      {
        question: "What is a Scott Schedule?",
        answer:
          "A Scott Schedule is a structured document used in construction litigation to set out each item of claim in a standardised format, listing the item, the amount claimed, the responding party's position, and the expert's view. Courts frequently order Scott Schedules in TCC proceedings to narrow the issues between the parties. Quantum experts populate or respond to Scott Schedules so that the court and the parties can see precisely where quantum agreement and disagreement lie before trial.",
      },
    ],
    relatedLinks: [
      {
      ...
      },
      {
        ...
        label: "Construction Quantum Expert Guide",
      },
    ],
  },
  {
    ...
    faqs: [
      {
        question: "How is loss calculated when an IT implementation fails?",
        answer:
    ...
    relatedLinks: [
      ...
      {
        href: "/case-types/ip-licence-breach",
        label: "IP Licence Breach",
      },
      {
        href: "/services#lost-profits",
        label: "Lost Profits Quantification",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    relatedLinks: [
      ...
      {
        href: "/case-types/distribution-agency-agreement",
        label: "Distribution & Agency Agreement",
      },
      {
        href: "/services#lost-profits",
        label: "Lost Profits Quantification",
  ...
  },
  {
    ...
    faqs: [
      {
        question: "How are take-or-pay losses calculated?",
        answer:
      ...
      {
        question: "What losses arise from a power purchase agreement breach?",
        answer:
    ...
    relatedLinks: [
      ...
      {
        href: "/case-types/joint-venture-dispute",
        label: "Joint Venture Dispute",
      },
      {
        href: "/services#consequential-loss",
        label: "Consequential Loss Assessment",
  ...
  },
  {
    ...
    faqs: [
      {
        question: "How is loss calculated when a production contract is breached?",
        answer:
